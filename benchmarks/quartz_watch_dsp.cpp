/**
 * quartz_watch_dsp — benchmark du pipeline DSP FrequencyCounter pour quartz 32768 Hz
 *
 * Signal d'entrée : sinusoïde à 32768 Hz (fréquence du quartz).
 * analytic_signal = false (utilise la chaîne de mixing LO + Hilbert du DSP).
 ...
 *
 * Utilisation :
 *   ./benchmarks/quartz_watch_dsp --buffers 1000 --buffer-size 16
 *   ./benchmarks/quartz_watch_dsp --help
 */
...
int main(int argc, char **argv) {
    CLI::App app{"Benchmark FrequencyCounter DSP pipeline (quartz 32768 Hz)"};
